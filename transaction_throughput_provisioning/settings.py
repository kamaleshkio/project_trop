"""
Django settings for transaction_throughput_provisioning project.
...
from transaction_throughput_provisioning.emailsetting import SET_EMAIL_USE_TLS, SET_EMAIL_HOST, SET_EMAIL_HOST_USER, \
...
SECRET_KEY = 'vp$mv%4-$9n+zq728x&%)j_7_7gd#=l69hg%itiuz(%!c&xnhy'
...
ROOT_URLCONF = 'transaction_throughput_provisioning.urls'
...
WSGI_APPLICATION = 'transaction_throughput_provisioning.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'transaction_throughput_prov',
        'USER': 'root',
        'PASSWORD': '',
        'HOST': '127.0.0.1',
        'PORT': '3306',
